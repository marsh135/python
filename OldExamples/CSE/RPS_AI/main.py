...
import Amy_Kim, Choi, Crystal_Sam, its_late, TeamKyleandMike, pulleyMarshB19  # These are file names in this folder     
...
importlib.reload(Amy_Kim) 
#importlib.reload(Choi)
importlib.reload(Crystal_Sam)
importlib.reload(its_late)
importlib.reload(TeamKyleandMike)
#importlib.reload(team6)
importlib.reload(pulleyMarshB19)
...
short_report, long_report = psrock.round_robin(200, Amy_Kim, Crystal_Sam, its_late, TeamKyleandMike, pulleyMarshB19)        
